...
function makeProduct(id, color, desc, cost){
  var discount = 0;
  return {
    id: id,
    color: color,
...
// client code//
var myProduct = makeProduct ('abc','iPhone6','tiny break box', 500.00);
console.log(iPhone6.getPrice);
console.log(iPhone6.setDiscount(200));
console.log(iPhone6.getPrice());

var android = makeProduct( 'xyz', 'android galaxy6', 'way better than Apple', 600.00);
console.log()
